<script lang="ts">
	...
	onMount(async () => {
		const response = await fetch('https://gh-contributions-api.vercel.app/igorbrum/2023');
...
<T.PerspectiveCamera makeDefault position={[0, 50, 300]} fov={60}>
	<OrbitControls enableDamping autoRotate></OrbitControls>
</T.PerspectiveCamera>
